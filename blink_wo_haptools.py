...
def main():
    ...
    if args.command == 'simdata':
        ...
        print('This build does not have haptools, please ensure that you have correctly installed the prerequisites and re-install blink. See README for more info.')
