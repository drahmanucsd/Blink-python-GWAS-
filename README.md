...
# Blink-python-GWAS
This tool, Blink, is used to perform genome-wide association studies (GWAS). GWAS is important as it helps scientists identify genes associated with diseases or traits. Our implementation will compared to a GWAS tool called plink which is well-known in the bioinformatic field. Please view `Notes.md` for our citations.
...
```
* It will take a while because it is an over 2 GB
...
Ex: `blink gwas --geno ~/public/lab3/lab3_gwas.vcf.gz --phen ~/public/lab3/lab3_gwas.phen --out [INSERT NAME] --maf 0.05`
...
# Credits
This repository was generated by Abhishek Ganga, Daniyal Rahman, and Jung Tzen Liew with inspiration from plink, haptools, and the CSE 185 Lab 3 projects. See `Notes.md` for our citations. Please submit a pull request with any corrections or suggestions! We accept all criticism.
